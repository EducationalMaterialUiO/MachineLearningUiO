...
and the PDF file is at https://github.com/EducationalMaterialUiO/MachineLearningUiO/blob/main/doc/BookML/Lecturebook.pdf
All lectures can be accessed either in person or live via zoom at https://uio.zoom.us/my/mortenhj
...
- Work on numerical projects to illustrate the theory. The projects play a central role and you are expected to know modern programming languages like Python, Julia or C++ and/or Fortran (Fortran2003 or later).  
...
The following topics (not all) are typically  covered:
...
* Morten Hjorth-Jensen, mhjensen@uio.no
  ...
  * _Office hours_: *Anytime*! Individual or group office hours can be performed either in person or via zoom. Feel free to send an email/text for planning.
...
* Kim Graaturd, kim.graatrud@fys.uio.no

## Practicalities

1. The sessions on Wednesdays last four hours for each group (four in total) and the focus is work on exercices and projects.  The sessions will begin with lectures and questions and answers about the material to be covered every week.
